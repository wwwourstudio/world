...
\`\`\`json
{
  "commands": [
    ...
    { "action": "add_particle", "preset": "scatter|rain|snow|leaves|sparks|fire|smoke|magic|custom", "count": 200, "spread": [8,8,8], "color": "#ffffff", "position": [0,0,0],
      "// advanced": "lifetime(s,0=∞), emitterShape(point|sphere|box|cone|hemisphere|ring), gravityFactor(-3→3), drag(0→1), turbulence(0→5), velocityX/Y/Z, renderMode(mesh|billboard|point), opacityStart/End, glowIntensity(0→2)" },
